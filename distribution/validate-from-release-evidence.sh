...
winget_locale="$winget_dir/QuickSType.QuickSType.locale.en-US.yaml"
...
require_contains "$winget_locale" "PackageIdentifier: QuickSType.QuickSType"
require_contains "$winget_locale" "PackageVersion: $version"
require_contains "$winget_locale" "PackageName: QuickSType"
